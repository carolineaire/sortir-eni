 ...
 */
final class Version20260224124701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etats DROP id_etat, CHANGE id no_etat INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (no_etat)');
        ...
        $this->addSql('ALTER TABLE lieux ADD villes_no_ville INT NOT NULL, DROP id_lieu, DROP no_villes_id, CHANGE id no_lieu INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (no_lieu)');
        ...
        $this->addSql('ALTER TABLE sorties ADD lieux_no_lieu INT NOT NULL, ADD etats_no_etat INT NOT NULL, DROP id_sortie, DROP no_lieux_id, DROP no_etats_id, CHANGE id no_sortie INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (no_sortie)');
        ...
        $this->addSql('ALTER TABLE villes DROP id_ville, CHANGE id no_ville INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (no_ville)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE etats MODIFY no_etat INT NOT NULL');
        $this->addSql('ALTER TABLE etats ADD id_etat INT NOT NULL, CHANGE no_etat id INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        ...
        $this->addSql('ALTER TABLE lieux MODIFY no_lieu INT NOT NULL');
        $this->addSql('ALTER TABLE lieux ADD no_villes_id INT NOT NULL, CHANGE no_lieu id INT AUTO_INCREMENT NOT NULL, CHANGE villes_no_ville id_lieu INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        ...
        $this->addSql('ALTER TABLE sorties MODIFY no_sortie INT NOT NULL');
        $this->addSql('ALTER TABLE sorties ADD id_sortie INT NOT NULL, ADD no_lieux_id INT NOT NULL, ADD no_etats_id INT NOT NULL, DROP lieux_no_lieu, DROP etats_no_etat, CHANGE no_sortie id INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        ...
        $this->addSql('ALTER TABLE villes MODIFY no_ville INT NOT NULL');
        $this->addSql('ALTER TABLE villes ADD id_ville INT NOT NULL, CHANGE no_ville id INT AUTO_INCREMENT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    }
}
